    ...
    parse: function(input, startRule) {
      ...
      function parse_biconditional() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, left, right) { 
          		...
          		node.LNode = left;
          		node.RNode = right;
          		node.operation = "biconditional";
          		return node;})(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_primary() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, biconditional) { return biconditional; })(pos0, result0[1]);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_terminal() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, letter) { 
          		var node = new PL_Node();
          		node.variable = letter.join("");
              return node;})(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
